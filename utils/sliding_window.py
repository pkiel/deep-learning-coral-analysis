...
parser.add_argument("coords", nargs="+", type=int,
                    help="Coordinates of the top left and top right of the correctly labelled area (top_x top_y bottom_x bottom_y)")
parser.add_argument("--size", action="store", dest="size", type=int, default=256, help="Size of images to output")
parser.add_argument("--stride", action="store", dest="stride", type=int, default=20,
                    help="Stride between the start of the output images")
parser.add_argument("--suffix", action="store", dest="suffix", type=str, default="_label",
                    help="Suffix that is appended to the label")
